        ...
        h += `<tr>
          ...
          ${withActions ? (i===0
            ? `<td style="white-space:nowrap">
                <button class="btn small secondary" title="Corriger" onclick="App.editEntry('${e.id}')">✎ Modifier</button>
                <button class="btn small danger"    title="Supprimer" onclick="App.deleteEntry('${e.id}')">✕</button></td>`
            : "<td></td>") : ""}
        </tr>`;
      });
    });
